...
/** Turns the first mention of each glossary term into a button that explains it. Ported from Flack. */
 ...
 * term turned into a button that explains it. Ported from Flack.
 */
